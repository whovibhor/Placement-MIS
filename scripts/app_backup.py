...
def upload():
    ...
    # Also catch stringified "nan" that pandas produces from empty Excel cells
...
def dashboard():
    try:
        ...
        placement_rate = round((placed / opted_in * 100), 1) if opted_in else 0
        ...
        rows = []
        analytics = {}
    return render_template("dashboard.html", students_json=rows, analytics=analytics)
